...
const spherecordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(spherecordDir, "Uninstall SphereCord.exe"));

export const DATA_DIR =
    process.env.EQUICORD_USER_DATA_DIR || (PORTABLE ? join(spherecordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `SphereCord/${app.getVersion()} (https://github.com/Project-Colony/SphereCord)`;
